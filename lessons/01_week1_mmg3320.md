...
### How to log-in without VACC-OOD
...
To use OFF-campus you will need to VPN first. See
...
```bash 
cp -r /gpfs1/cl/mmg3320/course_materials/tutorials/mmg232/unix_lesson .
```

> Let's break this down.  
'cp' is the command for copy. This command required you to specify the
location of the item you want to copy
(/gpfs1/cl/mmg3320/course_materials/tutorials/mmg232/unix_lesson) and the
